...
#define MOTOR_DRV_HS_DISABLE_ALL_MASK	(_02_TMRD_TRDIOB0_OUTPUT_DISABLE | _04_TMRD_TRDIOC0_OUTPUT_DISABLE | _08_TMRD_TRDIOD0_OUTPUT_DISABLE)
#define MOTOR_DRV_LS_DISABLE_ALL_MASK	(_20_TMRD_TRDIOB1_OUTPUT_DISABLE | _40_TMRD_TRDIOC1_OUTPUT_DISABLE | _80_TMRD_TRDIOD1_OUTPUT_DISABLE)
#define MOTOR_DRV_DISABLE_ALL_MASK		(MOTOR_DRV_HS_DISABLE_ALL_MASK | MOTOR_DRV_LS_DISABLE_ALL_MASK)
#define MOTOR_DRV_HS_ENABLE_A_MASK		_02_TMRD_TRDIOB0_OUTPUT_DISABLE
#define MOTOR_DRV_HS_ENABLE_B_MASK		_04_TMRD_TRDIOC0_OUTPUT_DISABLE
#define MOTOR_DRV_HS_ENABLE_C_MASK		_08_TMRD_TRDIOD0_OUTPUT_DISABLE
#define MOTOR_DRV_LS_ENABLE_A_MASK		_20_TMRD_TRDIOB1_OUTPUT_DISABLE
#define MOTOR_DRV_LS_ENABLE_B_MASK		_40_TMRD_TRDIOC1_OUTPUT_DISABLE
#define MOTOR_DRV_LS_ENABLE_C_MASK		_80_TMRD_TRDIOD1_OUTPUT_DISABLE
#define MOTOR_DRV_HS_DISABLE_A_MASK		_02_TMRD_TRDIOB0_OUTPUT_DISABLE
#define MOTOR_DRV_HS_DISABLE_B_MASK		_04_TMRD_TRDIOC0_OUTPUT_DISABLE
#define MOTOR_DRV_HS_DISABLE_C_MASK		_08_TMRD_TRDIOD0_OUTPUT_DISABLE
#define MOTOR_DRV_LS_DISABLE_A_MASK		_20_TMRD_TRDIOB1_OUTPUT_DISABLE
#define MOTOR_DRV_LS_DISABLE_B_MASK		_40_TMRD_TRDIOC1_OUTPUT_DISABLE
#define MOTOR_DRV_LS_DISABLE_C_MASK		_80_TMRD_TRDIOD1_OUTPUT_DISABLE
